...
{block name='frontend_index_content'}
	...
	{if !empty($registrations)}
		...
		<div id="wpwl-registrations">
			<div class="wpwl-container wpwl-container-registration wpwl-clearfix" style="display: block;">
					<form class="wpwl-form wpwl-form-registrations wpwl-form-has-inputs wpwl-clearfix" action="{url controller=payment_processor action=result pm=$paymentMethod}" method="POST" lang="en" accept-charset="UTF-8" data-action="submit-registration">
	...
	{/literal}
	<form action="{url controller=payment_processor action=result pm=$paymentMethod}" class="paymentWidgets">{$brand}</form>
{/block}
